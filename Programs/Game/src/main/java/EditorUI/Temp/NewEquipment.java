...
public class NewEquipment extends SceneInterface {
    @FXML
...
//            if(skillConfig.getClass() == EmptySkillConfig.class) continue;
            ...
            controller.setData(skillConfig);
        }
    }
    ...
    private EquipmentPane loadEquipmentPane(){
        try {
            FXMLLoader loader = new FXMLLoader(Equipment.class.getResource(SceneLoader.PaneType.NEW_EQUIPMENT_PANE.getPath()));
